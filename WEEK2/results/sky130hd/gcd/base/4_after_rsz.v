module gcd (clk,
 ...
 sky130_fd_sc_hd__nor4_1 _157_ (.A(net167),
    ...
    .D(net183),
    .Y(_004_));
 sky130_fd_sc_hd__nor4_4 _158_ (.A(net170),
    .B(net172),
    .C(net173),
    .D(net286),
    .Y(_005_));
 sky130_fd_sc_hd__nor4_4 _159_ (.A(net175),
    ...
    .D(net177),
    .Y(_006_));
 sky130_fd_sc_hd__nor4_2 _160_ (.A(net180),
    .B(net181),
    .C(net182),
    .D(net165),
    .Y(_007_));
 ...
 sky130_fd_sc_hd__nor2b_4 _174_ (.A(\dpath.a_lt_b$in0[0] ),
    ...
    .Y(_015_));
 sky130_fd_sc_hd__xnor2_2 _175_ (.A(net286),
    .B(net188),
    .Y(_016_));
 ...
 sky130_fd_sc_hd__nand2_1 _194_ (.A(net186),
    .B(net137),
    .Y(_031_));
 sky130_fd_sc_hd__o21ai_2 _195_ (.A1(net170),
    .A2(_030_),
    .B1(_031_),
    .Y(_032_));
 ...
 sky130_fd_sc_hd__xnor2_1 _208_ (.A(net167),
    .B(net184),
    .Y(_043_));
 sky130_fd_sc_hd__xnor2_4 _209_ (.A(_043_),
    .B(net136),
    .Y(net50));
 ...
 sky130_fd_sc_hd__nand2_1 _215_ (.A(net156),
    .B(net155),
    .Y(_049_));
 sky130_fd_sc_hd__xnor2_2 _216_ (.A(net208),
    .B(_049_),
    .Y(net51));
 ...
 sky130_fd_sc_hd__a21boi_4 _218_ (.A1(net134),
    ...
    .B1_N(net156),
    .Y(_051_));
 sky130_fd_sc_hd__xnor2_2 _219_ (.A(_051_),
    .B(net154),
    .Y(net52));
 ...
 sky130_fd_sc_hd__a21oi_1 _231_ (.A1(net152),
    ...
    .B1(net153),
    .Y(_062_));
 sky130_fd_sc_hd__a21oi_2 _232_ (.A1(net210),
    .A2(_059_),
    .B1(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__xnor2_1 _233_ (.A(_063_),
    .B(net193),
    .Y(_064_));
 ...
 sky130_fd_sc_hd__xnor2_1 _244_ (.A(net180),
    .B(net192),
    .Y(_074_));
 sky130_fd_sc_hd__xnor2_2 _245_ (.A(_074_),
    .B(net132),
    .Y(net40));
 ...
 sky130_fd_sc_hd__a21o_1 _262_ (.A1(net179),
    ...
    .B1(_089_),
    .X(_090_));
 sky130_fd_sc_hd__nor3_2 _263_ (.A(_088_),
    .B(_090_),
    .C(_085_),
    .Y(_091_));
 ...
 sky130_fd_sc_hd__o31ai_4 _274_ (.A1(_097_),
    ...
    .B1(_094_),
    .Y(_100_));
 sky130_fd_sc_hd__a21o_4 _277_ (.A1(net195),
    .A2(net204),
    .B1(net289),
    .X(\ctrl$b_reg_en[0] ));
 ...
 sky130_fd_sc_hd__nor2_1 _283_ (.A(net8),
    .B(net147),
    .Y(_108_));
 sky130_fd_sc_hd__a31oi_1 _284_ (.A1(_107_),
    .A2(net147),
    .A3(_106_),
    .B1(_108_),
    .Y(\dpath.a_mux$out[0] ));
 ...
 sky130_fd_sc_hd__nand2_1 _337_ (.A(net288),
    .B(net1),
    .Y(_146_));
 sky130_fd_sc_hd__o21ai_1 _338_ (.A1(net288),
    .A2(net145),
    .B1(_146_),
    .Y(\dpath.b_mux$out[0] ));
 ...
 sky130_fd_sc_hd__o31ai_2 clone204 (.A1(_097_),
    .A2(_093_),
    .A3(net205),
    .B1(_094_),
    .Y(net204));
 ...
 sky130_fd_sc_hd__buf_4 place135 (.A(_032_),
    .X(net135));
 sky130_fd_sc_hd__buf_6 place136 (.A(net201),
    .X(net136));
 ...
 sky130_fd_sc_hd__buf_4 place176 (.A(\dpath.a_lt_b$in1[14] ),
    .X(net176));
 sky130_fd_sc_hd__buf_4 place177 (.A(net292),
    .X(net177));
 ...
 sky130_fd_sc_hd__buf_4 rebuffer203 (.A(net204),
    .X(net203));
 sky130_fd_sc_hd__buf_4 rebuffer205 (.A(_098_),
    .X(net205));
 sky130_fd_sc_hd__buf_4 rebuffer206 (.A(_098_),
    .X(net206));
 sky130_fd_sc_hd__buf_4 rebuffer207 (.A(net42),
    .X(net207));
 sky130_fd_sc_hd__buf_4 rebuffer208 (.A(net134),
    .X(net208));
 sky130_fd_sc_hd__buf_4 rebuffer210 (.A(net212),
    .X(net210));
 sky130_fd_sc_hd__buf_4 rebuffer212 (.A(net134),
    .X(net212));
 sky130_fd_sc_hd__buf_4 rebuffer215 (.A(net49),
    .X(net215));
 sky130_fd_sc_hd__buf_4 rebuffer216 (.A(_025_),
    .X(net216));
 sky130_fd_sc_hd__buf_4 rebuffer245 (.A(_032_),
    .X(net245));
 sky130_fd_sc_hd__buf_4 rebuffer248 (.A(net50),
    .X(net248));
 sky130_fd_sc_hd__buf_4 rebuffer286 (.A(\dpath.a_lt_b$in1[1] ),
    .X(net286));
 ...
 sky130_fd_sc_hd__buf_6 rebuffer290 (.A(net197),
    .X(net290));
 sky130_fd_sc_hd__buf_4 rebuffer292 (.A(\dpath.a_lt_b$in1[14] ),
    .X(net292));
endmodule
