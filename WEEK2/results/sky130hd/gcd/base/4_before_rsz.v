module gcd (clk,
 ...
 sky130_fd_sc_hd__nor4_1 _157_ (.A(net167),
    .B(net168),
    .C(net169),
    .D(net183),
    .Y(_004_));
 sky130_fd_sc_hd__nor4_1 _158_ (.A(net170),
    .B(net172),
    .C(net173),
    .D(net174),
    .Y(_005_));
 sky130_fd_sc_hd__nor4_1 _159_ (.A(net175),
    .B(net177),
    .C(net179),
    .D(net166),
    .Y(_006_));
 sky130_fd_sc_hd__nor4_1 _160_ (.A(net180),
    .B(net181),
    .C(net182),
    .D(net165),
    .Y(_007_));
 sky130_fd_sc_hd__nand4_1 _161_ (.A(net163),
    .B(_005_),
    .C(net162),
    .D(_007_),
    .Y(_008_));
 sky130_fd_sc_hd__a22oi_1 _162_ (.A1(net197),
    .A2(net199),
    .B1(_008_),
    .B2(net195),
    .Y(_009_));
 ...
 sky130_fd_sc_hd__inv_1 _167_ (.A(net33),
    .Y(_011_));
 sky130_fd_sc_hd__a221o_1 _168_ (.A1(net197),
    .A2(_011_),
    .B1(net35),
    .B2(net53),
    .C1(net34),
 ...
 sky130_fd_sc_hd__inv_1 _169_ (.A(net35),
    .Y(_012_));
 sky130_fd_sc_hd__o21ai_0 _170_ (.A1(net197),
    .A2(_012_),
    .B1(\ctrl.state.out[1] ),
    .Y(_013_));
 sky130_fd_sc_hd__a21bo_2 _171_ (.A1(net161),
    .A2(_008_),
    .B1_N(net195),
    .X(_014_));
 sky130_fd_sc_hd__a21oi_1 _172_ (.A1(_013_),
    .A2(_014_),
    .B1(net198),
    .Y(_001_));
 ...
 sky130_fd_sc_hd__nor2b_4 _174_ (.A(\dpath.a_lt_b$in0[0] ),
    ...
    .Y(_015_));
 sky130_fd_sc_hd__xnor2_1 _175_ (.A(net174),
    .B(net188),
    .Y(_016_));
 sky130_fd_sc_hd__xnor2_1 _176_ (.A(net159),
    .B(_016_),
    .Y(net44));
 ...
 sky130_fd_sc_hd__xnor2_1 _179_ (.A(net173),
    .B(net187),
    .Y(_019_));
 sky130_fd_sc_hd__xnor2_1 _180_ (.A(net142),
    .B(_019_),
    .Y(net45));
 ...
 sky130_fd_sc_hd__o21ai_1 _195_ (.A1(_030_),
    ...
    .B1(_031_),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_1 _196_ (.A(net135),
    .B(_029_),
    .Y(net48));
 ...
 sky130_fd_sc_hd__xnor2_1 _208_ (.A(net167),
    .B(net184),
    .Y(_043_));
 sky130_fd_sc_hd__xnor2_1 _209_ (.A(net136),
    .B(_043_),
    .Y(net50));
 ...
 sky130_fd_sc_hd__nand2_1 _215_ (.A(net156),
    .B(net155),
    .Y(_049_));
 sky130_fd_sc_hd__xnor2_1 _216_ (.A(net134),
    .B(_049_),
    .Y(net51));
 sky130_fd_sc_hd__xnor2_1 _217_ (.A(\dpath.a_lt_b$in1[9] ),
    .B(\dpath.a_lt_b$in0[9] ),
    .Y(_050_));
 sky130_fd_sc_hd__a21boi_0 _218_ (.A1(net134),
    .A2(net155),
    .B1_N(net156),
    .Y(_051_));
 sky130_fd_sc_hd__xnor2_1 _219_ (.A(net154),
    .B(_051_),
    .Y(net52));
 ...
 sky130_fd_sc_hd__nor2b_1 _224_ (.A(\dpath.a_lt_b$in0[9] ),
    .B_N(net164),
    .Y(_056_));
 sky130_fd_sc_hd__a21oi_1 _225_ (.A1(_055_),
    .A2(_051_),
    .B1(_056_),
    .Y(_057_));
 sky130_fd_sc_hd__xor2_1 _226_ (.A(net140),
    .B(_057_),
    .X(net38));
 ...
 sky130_fd_sc_hd__a21oi_1 _231_ (.A1(net152),
    ...
    .B1(net153),
    .Y(_062_));
 sky130_fd_sc_hd__a21oi_1 _232_ (.A1(net134),
    .A2(_059_),
    .B1(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__xnor2_1 _233_ (.A(net193),
    .B(_063_),
    .Y(_064_));
 ...
 sky130_fd_sc_hd__xnor2_1 _244_ (.A(net180),
    .B(net192),
    .Y(_074_));
 sky130_fd_sc_hd__xnor2_1 _245_ (.A(net132),
    .B(_074_),
    .Y(net40));
 sky130_fd_sc_hd__inv_1 _246_ (.A(\dpath.a_lt_b$in0[12] ),
    .Y(_075_));
 sky130_fd_sc_hd__maj3_1 _247_ (.A(net180),
    .B(net148),
    .C(_073_),
    .X(_076_));
 sky130_fd_sc_hd__xnor2_1 _248_ (.A(net191),
    .B(_076_),
    .Y(_077_));
 sky130_fd_sc_hd__xnor2_1 _249_ (.A(net178),
    .B(_077_),
    .Y(net41));
 ...
 sky130_fd_sc_hd__a21o_4 _277_ (.A1(_100_),
    ...
    .B1(net197),
    .X(\ctrl$b_reg_en[0] ));
 sky130_fd_sc_hd__nor2b_1 _278_ (.A(net197),
    .B_N(net195),
    .Y(_103_));
 sky130_fd_sc_hd__inv_1 _280_ (.A(net194),
    .Y(_105_));
 ...
 sky130_fd_sc_hd__nor2_1 _283_ (.A(net8),
    .B(net147),
    .Y(_108_));
 sky130_fd_sc_hd__a31oi_1 _284_ (.A1(net147),
    .A2(_107_),
    .A3(_106_),
    .B1(_108_),
    .Y(\dpath.a_mux$out[0] ));
 sky130_fd_sc_hd__nand2b_1 _285_ (.A_N(net197),
    .B(net195),
    .Y(_109_));
 ...
 sky130_fd_sc_hd__o21ai_0 _305_ (.A1(net139),
    .A2(_098_),
    .B1(net189),
    .Y(_124_));
 sky130_fd_sc_hd__xor2_1 _306_ (.A(net175),
    .B(_124_),
    .X(_125_));
 sky130_fd_sc_hd__nand2_1 _307_ (.A(net25),
    .B(net143),
    .Y(_126_));
 sky130_fd_sc_hd__o21ai_0 _308_ (.A1(net143),
    .A2(_125_),
    .B1(_126_),
 ...
 sky130_fd_sc_hd__nand2_1 _322_ (.A(net14),
    .B(net144),
    .Y(_136_));
 sky130_fd_sc_hd__o21ai_1 _323_ (.A1(net144),
    .A2(_135_),
    .B1(_136_),
    .Y(\dpath.a_mux$out[5] ));
 ...
 sky130_fd_sc_hd__o21ai_1 _335_ (.A1(net143),
    ...
    .B1(_144_),
    .Y(\dpath.a_mux$out[9] ));
 sky130_fd_sc_hd__nand2_1 _337_ (.A(net197),
    .B(net1),
    .Y(_146_));
 sky130_fd_sc_hd__o21ai_0 _338_ (.A1(net197),
    .A2(net145),
    .B1(_146_),
    .Y(\dpath.b_mux$out[0] ));
 sky130_fd_sc_hd__nand2_1 _339_ (.A(net197),
    .B(net2),
    .Y(_147_));
 sky130_fd_sc_hd__o21ai_0 _340_ (.A1(net197),
    .A2(net149),
    .B1(_147_),
    .Y(\dpath.b_mux$out[10] ));
 sky130_fd_sc_hd__mux2_2 _341_ (.A0(net193),
    .A1(net3),
    .S(net197),
 ...
 sky130_fd_sc_hd__mux2_2 _348_ (.A0(net189),
    .A1(net7),
    .S(net197),
    .X(\dpath.b_mux$out[15] ));
 sky130_fd_sc_hd__nand2_1 _349_ (.A(net197),
    .B(net12),
    .Y(_151_));
 sky130_fd_sc_hd__o21ai_0 _350_ (.A1(net197),
    .A2(_017_),
    .B1(_151_),
    .Y(\dpath.b_mux$out[1] ));
 sky130_fd_sc_hd__nand2_1 _351_ (.A(net197),
    .B(net23),
    .Y(_152_));
 sky130_fd_sc_hd__o21ai_0 _352_ (.A1(net197),
    .A2(_023_),
    .B1(_152_),
    .Y(\dpath.b_mux$out[2] ));
 sky130_fd_sc_hd__mux2_2 _353_ (.A0(\dpath.a_lt_b$in0[3] ),
    ...
    .S(net197),
    .X(\dpath.b_mux$out[3] ));
 sky130_fd_sc_hd__nand2_1 _354_ (.A(net197),
    .B(net27),
    .Y(_153_));
 sky130_fd_sc_hd__o21ai_0 _355_ (.A1(net197),
    .A2(net157),
    .B1(_153_),
    .Y(\dpath.b_mux$out[4] ));
 sky130_fd_sc_hd__mux2_2 _356_ (.A0(\dpath.a_lt_b$in0[5] ),
    ...
    .S(net197),
    .X(\dpath.b_mux$out[5] ));
 sky130_fd_sc_hd__mux2_2 _357_ (.A0(net185),
    .A1(net29),
    .S(net197),
    .X(\dpath.b_mux$out[6] ));
 sky130_fd_sc_hd__nand2_1 _358_ (.A(net196),
    .B(net30),
    .Y(_154_));
 ...
 sky130_fd_sc_hd__mux2_2 _360_ (.A0(\dpath.a_lt_b$in0[8] ),
    ...
    .S(net197),
    .X(\dpath.b_mux$out[8] ));
 sky130_fd_sc_hd__nand2_1 _361_ (.A(net197),
    .B(net32),
    .Y(_155_));
 sky130_fd_sc_hd__o21ai_0 _362_ (.A1(net197),
    .A2(net150),
    .B1(_155_),
    .Y(\dpath.b_mux$out[9] ));
 ...
 sky130_fd_sc_hd__clkdlybuf4s50_1 input9 (.A(req_msg[17]),
    .X(net9));
 sky130_fd_sc_hd__clkdlybuf4s50_1 output36 (.A(net197),
    .X(req_rdy));
 ...
 sky130_fd_sc_hd__buf_4 place126 (.A(_100_),
    .X(net126));
 sky130_fd_sc_hd__buf_4 place127 (.A(net42),
    .X(net127));
 ...
 sky130_fd_sc_hd__buf_4 place131 (.A(net52),
    .X(net131));
 sky130_fd_sc_hd__buf_4 place132 (.A(_073_),
    .X(net132));
 sky130_fd_sc_hd__buf_4 place133 (.A(net48),
    .X(net133));
 sky130_fd_sc_hd__buf_4 place134 (.A(_046_),
    .X(net134));
 sky130_fd_sc_hd__buf_4 place135 (.A(_032_),
    .X(net135));
 sky130_fd_sc_hd__buf_4 place136 (.A(_042_),
    .X(net136));
 sky130_fd_sc_hd__buf_4 place137 (.A(_025_),
    .X(net137));
 ...
 sky130_fd_sc_hd__buf_4 place144 (.A(_109_),
    .X(net144));
 sky130_fd_sc_hd__buf_4 place145 (.A(_105_),
    .X(net145));
 ...
 sky130_fd_sc_hd__buf_4 place158 (.A(_035_),
    .X(net158));
 sky130_fd_sc_hd__buf_4 place159 (.A(_015_),
    .X(net159));
 sky130_fd_sc_hd__buf_4 place160 (.A(\ctrl$a_reg_en[0] ),
    .X(net160));
 sky130_fd_sc_hd__buf_4 place161 (.A(_010_),
    .X(net161));
 sky130_fd_sc_hd__buf_4 place162 (.A(_006_),
    .X(net162));
 sky130_fd_sc_hd__buf_4 place163 (.A(_004_),
    .X(net163));
 ...
 sky130_fd_sc_hd__buf_4 place166 (.A(\dpath.a_lt_b$in1[8] ),
    .X(net166));
 sky130_fd_sc_hd__buf_4 place167 (.A(\dpath.a_lt_b$in1[7] ),
    .X(net167));
 ...
 sky130_fd_sc_hd__buf_4 place187 (.A(\dpath.a_lt_b$in0[2] ),
    .X(net187));
 sky130_fd_sc_hd__buf_4 place188 (.A(\dpath.a_lt_b$in0[1] ),
    .X(net188));
 ...
 sky130_fd_sc_hd__buf_4 place193 (.A(\dpath.a_lt_b$in0[11] ),
    .X(net193));
 sky130_fd_sc_hd__buf_4 place194 (.A(\dpath.a_lt_b$in0[0] ),
    .X(net194));
 sky130_fd_sc_hd__buf_4 place195 (.A(\ctrl.state.out[2] ),
    .X(net195));
 sky130_fd_sc_hd__buf_4 place196 (.A(net197),
    .X(net196));
 sky130_fd_sc_hd__buf_4 place197 (.A(net36),
    .X(net197));
